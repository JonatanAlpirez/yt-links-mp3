...
def test_write_failed_links_preserves_original_order(tmp_path: Path) -> None:
    ...
    e1 = LinkEntry(
        video_id="id1", url="https://youtu.be/id1", description=None, line_number=1, raw="id1"
    )
    e2 = LinkEntry(
        video_id="id2", url="https://youtu.be/id2", description=None, line_number=2, raw="id2"
    )
    e3 = LinkEntry(
        video_id="id3", url="https://youtu.be/id3", description=None, line_number=3, raw="id3"
    )
